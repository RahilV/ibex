...
<head>
  ...
  <title>Holographic Wallpaper</title>
...
<body>
<section class="menu cid-qyvZvAATCr" once="menu" id="menu1-24" data-rv-view="577">
...
<section class="engine"><a href="https://mobirise.co/b">web site creator</a></section><section class="header1 cid-qyY5uCfvKu mbr-parallax-background" id="header1-25" data-rv-view="579">
...
<section class="mbr-section article content10 cid-qyY5we5RX6" id="content10-26" data-rv-view="582">
    ...
    <div class="container">
        <div class="inner-container" style="width: 66%;">
            ...
            <div class="section-text align-center mbr-white mbr-fonts-style display-5">Amazing 3D Wallpapers for Android</div>
            <hr class="line" style="width: 25%;">
        </div>
    </div>
</section>

<section class="cid-qyY5wJCsPm" id="video3-27" data-rv-view="584">

    
    
    <figure class="mbr-figure align-center container">
        <div class="video-block" style="width: 80%;">
            <div><iframe class="mbr-embedded-video" src="https://www.youtube.com/embed/xNfF1BenKyg?rel=0&amp;amp;showinfo=0&amp;autoplay=0&amp;loop=0" width="1280" height="720" frameborder="0" allowfullscreen></iframe></div>
        </div>
    </figure>
</section>

<section class="cid-qz2tWaEFth mbr-reveal" id="footer1-2c" data-rv-view="586">
