...
<body>
<section class="menu cid-qyvZvAATCr" once="menu" id="menu1-1p" data-rv-view="541">
...
<section class="engine"><a href="https://mobirise.co/g">how to create your own website for free</a></section><section class="header1 cid-qyY248Z5aA mbr-parallax-background" id="header1-1q" data-rv-view="543">
...
<section class="mbr-section article content10 cid-qyY25is81s" id="content10-1r" data-rv-view="546">
    ...
    <div class="container">
        <div class="inner-container" style="width: 66%;">
            ...
            <div class="section-text align-center mbr-white mbr-fonts-style display-5">Methods of Hacking!</div>
            <hr class="line" style="width: 25%;">
        </div>
    </div>
</section>

<section class="cid-qyY26hzIK6" id="video3-1s" data-rv-view="548">

    
    
    <figure class="mbr-figure align-center container">
        <div class="video-block" style="width: 80%;">
            <div><iframe class="mbr-embedded-video" src="https://www.youtube.com/embed/AOxn2kf3HUc?rel=0&amp;amp;showinfo=0&amp;autoplay=0&amp;loop=0" width="1280" height="720" frameborder="0" allowfullscreen></iframe></div>
        </div>
    </figure>
</section>

<section class="cid-qz2ub0iL4T mbr-reveal" id="footer1-2f" data-rv-view="550">
