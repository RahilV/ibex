...
<body>
<section class="menu cid-qyvZvAATCr" once="menu" id="menu1-1z" data-rv-view="565">
...
<section class="engine"><a href="https://mobirise.co/o">bootstrap button</a></section><section class="header1 cid-qyY4GLxewD mbr-parallax-background" id="header1-20" data-rv-view="567">
...
<section class="mbr-section article content10 cid-qyY4NK4QYq" id="content10-21" data-rv-view="570">
    ...
    <div class="container">
        <div class="inner-container" style="width: 66%;">
            ...
            <div class="section-text align-center mbr-white mbr-fonts-style display-5">Life Hacks to make your life easier!</div>
            <hr class="line" style="width: 25%;">
        </div>
    </div>
</section>

<section class="cid-qyY4OhYA4D" id="video3-22" data-rv-view="572">

    
    
    <figure class="mbr-figure align-center container">
        <div class="video-block" style="width: 80%;">
            <div><iframe class="mbr-embedded-video" src="https://www.youtube.com/embed/4c8qKI8qg3o?rel=0&amp;amp;showinfo=0&amp;autoplay=0&amp;loop=0" width="1280" height="720" frameborder="0" allowfullscreen></iframe></div>
        </div>
    </figure>
</section>

<section class="cid-qz2u1zJPfm mbr-reveal" id="footer1-2d" data-rv-view="574">
