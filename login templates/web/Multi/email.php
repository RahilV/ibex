...
'allow_self_signed' => true
    ...
    $mail->Username = 'shivanipatel327@gmail.com';                 // SMTP username
    $mail->Password = 'pictionary';                           // SMTP password
    $mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
    
    $mail->Port = 587;                                    // 587 TCP port to connect to

    //Recipients
    $mail->setFrom('shivanipatel327@gmail.com', 'Shivani');
    $mail->addAddress('shivanipatel327@gmail.com', 'Shivani');     // Add a recipient
    ...
    //Attachments
    //$mail->addAttachment('welcome.txt');         // Add attachments
    //$mail->addAttachment('welcome.txt');    // Optional name

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Greetings!';
    $mail->Body    = '<b>Welcome to IBEX!</b>';
