...
<body>
<section class="menu cid-qyvZvAATCr" once="menu" id="menu1-e" data-rv-view="450">
...
<section class="engine"><a href="https://mobirise.co/q">bootstrap carousel</a></section><section class="cid-qyvZvBQVq7 mbr-fullscreen mbr-parallax-background" id="header2-f" data-rv-view="452">
    ...
    <div class="container align-center">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                <h1 class="mbr-section-title mbr-bold pb-3 mbr-fonts-style display-1"><span style="font-weight: normal;">WELCOME TO IB</span><span style="font-weight: normal;">EX</span></h1>
                
                <p class="mbr-text pb-3 mbr-fonts-style display-5">NO EDGES NO LIMITS</p>
                <div class="mbr-section-btn"><a class="btn btn-md btn-secondary display-4" href="../index.html">GET STARTED</a>
            </div>
        </div>
    </div>
...
<section class="header7 cid-qyCbKOwv7b" id="header7-k" data-rv-view="455">
            ...
            <div class="media-content align-right">
                ...
                <div class="mbr-section-text mbr-white pb-3">
                    <p class="mbr-text mbr-fonts-style display-5">
                        CHECKOUT THIS VIDEO TO GET A COMPLETE OVERVIEW OF OUR WEBSITE<br></p>
                </div>
...
<section class="carousel slide cid-qyC3e4le6c" data-interval="false" id="slider2-h" data-rv-view="458">

    
    <div class="container content-slider">
        <div class="content-slider-wrap">
            <div><div class="mbr-slider slide carousel" data-pause="true" data-keyboard="false" data-ride="carousel" data-interval="4000"><ol class="carousel-indicators"><li data-app-prevent-settings="" data-target="#slider2-h" data-slide-to="0"></li><li data-app-prevent-settings="" data-target="#slider2-h" data-slide-to="1"></li><li data-app-prevent-settings="" data-target="#slider2-h" class=" active" data-slide-to="2"></li></ol><div class="carousel-inner" role="listbox"><div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(assets/images/pexels-photo-245032-1999x1333.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay"></div><img src="assets/images/pexels-photo-245032-1999x1333.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><p class="lead mbr-text mbr-fonts-style display-7">IBEX INTRODUCED YOUTUBE CHANNEL WHICH WILL&nbsp;<br>PROVIDE YOU<br>IRRESISTABLE AND STUNNING CONTENT</p></div></div></div></div></div><div class="carousel-item slider-fullscreen-image" data-bg-video-slide="false" style="background-image: url(assets/images/pexels-photo-160107-2000x1333.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay"></div><img src="assets/images/pexels-photo-160107-2000x1333.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><p class="lead mbr-text mbr-fonts-style display-7">HANDY FREEWARES AND PROGRAMS COLLECTED&nbsp;<br>AND DESIGNED BY US</p></div></div></div></div></div><div class="carousel-item slider-fullscreen-image active" data-bg-video-slide="false" style="background-image: url(assets/images/mbr-1-1620x1080.jpg);"><div class="container container-slide"><div class="image_wrapper"><div class="mbr-overlay"></div><img src="assets/images/mbr-1-1620x1080.jpg"><div class="carousel-caption justify-content-center"><div class="col-10 align-center"><p class="lead mbr-text mbr-fonts-style display-7">TECH STORE COMPRISING SIMPLE GADGETS AND<br>TECH LIFESTYLE PRODUCTS PRECISELY HANDPICKED</p></div></div></div></div></div></div><a data-app-prevent-settings="" class="carousel-control carousel-control-prev" role="button" data-slide="prev" href="#slider2-h"><span aria-hidden="true" class="mbri-left mbr-iconfont"></span><span class="sr-only">Previous</span></a><a data-app-prevent-settings="" class="carousel-control carousel-control-next" role="button" data-slide="next" href="#slider2-h"><span aria-hidden="true" class="mbri-right mbr-iconfont"></span><span class="sr-only">Next</span></a></div></div> 
        </div>
    </div>
</section>

<section class="cid-qyvZvCE5hD mbr-reveal" id="footer1-g" data-rv-view="470">
            ...
            <div class="col-12 col-md-3">
                <div class="media-wrap">
                    <a href="https://mobirise.com/">
                        <img src="assets/images/ibx-2-304x290.png" alt="Mobirise" title="" media-simple="true">
                    </a>
                </div>
            </div>
