    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent" align="justify-content-md-center">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                    <a class="nav-link link text-black display-4" href="page1.html"><span class="mbri-search mbr-iconfont mbr-iconfont-btn"></span>&nbsp; SEARCH &nbsp;</a>
                        ...
                        &nbsp;YOUTUBE &nbsp;&nbsp;</a></li><li class="nav-item dropdown"><a class="nav-link link text-black dropdown-toggle display-4" href="page1.html" data-toggle="dropdown-submenu" aria-expanded="false"><span class="mbri-mobile mbr-iconfont mbr-iconfont-btn"></span>PRODUCT&nbsp;</a><div class="dropdown-menu"><a class="text-black dropdown-item display-4" href="page3.html"><span class="mbri-code mbr-iconfont mbr-iconfont-btn"></span>SOFTWARES</a><a class="text-black dropdown-item display-4" href="page10.html"><span class="mbri-shopping-bag mbr-iconfont mbr-iconfont-btn"></span>LIFESTYLE</a><a class="text-black dropdown-item display-4" href="page2new.php"><span class="mbri-mobile mbr-iconfont mbr-iconfont-btn"></span>GADGETS</a><a class="text-black dropdown-item display-4" href="page1.html" aria-expanded="false"></a></div></li><li class="nav-item">
                    <a class="nav-link link text-black display-4" href="cart.php"><span class="mbri-shopping-cart mbr-iconfont mbr-iconfont-btn"></span>
                        &nbsp;CART</a>
                </li><li class="nav-item"><a class="nav-link link text-black display-4" href="page1.html" aria-expanded="true"><span class="mbri-logout mbr-iconfont mbr-iconfont-btn"></span>LOGOUT&nbsp;</a></li></ul>
            </div>
    </nav>
</section>
...
$i=0;
    ...
    ?>
        <tr>
        <td style="text-align:left;border-bottom:#F0F0F0 1px solid;"><img src="<?php echo $product_array [$i]["image"]; ?>" alt="" height="100"></td>
        <td style="text-align:left;border-bottom:#F0F0F0 1px solid;"><strong><?php echo $item["name"]; ?></strong></td>
        <td style="text-align:left;border-bottom:#F0F0F0 1px solid;"><?php echo $item["code"]; ?></td>
        <?php
        $getqty=$mysqli->query("SELECT quantity FROM cart_items WHERE user_id=4 AND product_id ='$it[$i]'");
