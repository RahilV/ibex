    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2">CONFIRM ORDER</h3>
...
<th style="text-align:center;"><strong>Shipping Address</strong></th>
</tr> 
<?php 
...
$i=0;
    ...
    ?>
        ...
        <?php
        $getqty=$mysqli->query("SELECT quantity FROM cart_items WHERE user_id= AND product_id ='$it[$i]'");
        ...
        <td style="text-align:center;border-bottom:#F0F0F0 1px solid;">
          <?php 
                $add=$mysqli->query("SELECT address FROM users WHERE id=$_SESSION[uid]");
                $array = array();
...
<tr>
<td colspan="6" style="text-align: right; padding-right: 100px;"><strong>Total:</strong> <?php      
 echo "₹".$item_total; ?></td>
</tr>
<tr>
<td colspan="6" style="text-align: right; padding-right: 20px;">
    ...
    <input type="submit" value="CANCEL" class="btn btn-md btn-secondary display-4" formaction="cart.php">
    <a href="merchant.php?total=<?php echo $item_total?>"><input type="submit" value="PAY" class="btn btn-md btn-secondary display-4" formaction="merchant.php"></a>
