...
<body>
<section class="menu cid-qyvZvAATCr" once="menu" id="menu1-1u" data-rv-view="553">
    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm bg-color transparent">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent"<div class="collapse navbar-collapse" id="navbarSupportedContent" align="justify-content-md-center">
...
<section class="engine"><a href="https://mobirise.co/j">design a website for free</a></section><section class="header1 cid-qyY2UL6sZr mbr-parallax-background" id="header1-1v" data-rv-view="555">
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="mbr-white col-md-10">
                ...
                <h3 class="mbr-section-subtitle align-center mbr-light pb-3 mbr-fonts-style display-2"><br>YOUTUBE CHANNEL<br></h3>
...
<section class="mbr-section article content10 cid-qyY2VmmUKP" id="content10-1w" data-rv-view="558">
    ...
    <div class="container">
        <div class="inner-container" style="width: 66%;">
            ...
            <div class="section-text align-center mbr-white mbr-fonts-style display-5">Make Android look like IOS !</div>
            <hr class="line" style="width: 25%;">
        </div>
    </div>
</section>

<section class="cid-qyY2VOum1v" id="video3-1x" data-rv-view="560">

    
    
    <figure class="mbr-figure align-center container">
        <div class="video-block" style="width: 80%;">
            <div><iframe class="mbr-embedded-video" src="https://www.youtube.com/embed/mwJyVVxjHQQ?rel=0&amp;amp;showinfo=0&amp;autoplay=0&amp;loop=0" width="1280" height="720" frameborder="0" allowfullscreen></iframe></div>
        </div>
    </figure>
</section>

<section class="cid-qz2u5NKz5U mbr-reveal" id="footer1-2e" data-rv-view="562">
